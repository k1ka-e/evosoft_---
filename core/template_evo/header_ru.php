...
<head>
    ...
    <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '189']) as $meta) : ?>
        <? if ($url == $meta['url']) : ?>
    ...
    <script src="<?php echo $template_path ?>/js/form.js" defer></script>
        ...
        <nav class="header">
            ...
            <div class="container nav_container">
                <div class="nav__content">
                    <div class="nav__left">
                        <div class="nav__logo">
                            <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '128']) as $navcontent) : ?>
                        ...
                        <select class="form-control" name="site_lang" onchange="change_lang()">
                            <option value="uz" <? if ($_GET['lang'] == 'uz') {
                                                    echo 'selected';
                                                } ?>>UZ</option>
                            <option value="ru" <? if ($_GET['lang'] == 'ru') {
                                                    echo 'selected';
                                                } ?>>RU</option>
                            <option value="en" <? if ($_GET['lang'] == 'en') {
                                                    echo 'selected';
                                                } ?>>EN</option>
                        </select>
                    </div>
                    ...
                    <div class="nav__right">
                        <ul class="nav_menu">
                            ...
                            <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '127']) as $navbar) : ?>
                                <li class="nav_link">
