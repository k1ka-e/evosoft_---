...
<footer class="contact">
  <div class="container">
    ...
    <? foreach (view::CONTENT('all_active',['IBLOCK_ID'=>'136 ']) as $contact):?>
        ...
        <div class="contact__content">
          <div class="contact__left">
            <form action="" method="post" id="contact_form">
              ...
              <button type="submit" class="btn-primary" id="send_contactform" name="contact_button">
                <?= $contact['button'] ?>
              </button>
            </form>
          </div>
        ...
        <? foreach (view::CONTENT('all_active',['IBLOCK_ID'=>'138']) as $contactForm) : ?>
