...
<footer class="contact">
  <div class="container">
    <div class="contact__body">
      ...
      <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '169']) as $contact) : ?>
        ...
        <div class="contact__right">
          <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '175']) as $contactForm) : ?>
            ...
            <div class="contact__btn">
              <div class="info__column">
                <div class="info__block">
                  <div class="info__title">Become a client</div>
              ...
              <div class="info__column">
                <div class="info__block black">
                  <div class="info__title">Become a Partner</div>
                  <a href="mailto:<?= $contactForm['email'] ?>" class="info__link"><?= $contactForm['email'] ?> </a>
                  <i class="arrow-long-right"></i>
                </div>
              </div>
              ...
              <div class="info__column">
                <div class="info__block">
                  <div class="info__title">Join lead team</div>
                  <a href="mailto:<?= $contactForm['email'] ?>" class="info__link"><?= $contactForm['email'] ?></a>
                  <i class="arrow-long-right"></i>
                </div>
              </div>
