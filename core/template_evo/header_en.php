...
<head>
    ...
    <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '190']) as $meta) : ?>
        <? if ($url == $meta['url']) : ?>
        ...
        <nav class="header">
            <div class="container nav_container">
                <div class="nav__content">
                    <div class="nav__left">
                        <div class="nav__logo">
                            <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '180']) as $navcontent) : ?>
                    ...
                    <div class="nav__right">
                        <ul class="nav_menu">
                            ...
                            <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '159']) as $navbar) : ?>
                                <li class="nav_link">
