...
$fields = [
    ...
    ['name' => 'text', 'name_db' => 'TEXT', 'type' => 'text', 'sort' => '350'],
    ['name' => 'title2', 'name_db' => 'TITLE2', 'type' => 'text', 'sort' => '400'],
    ['name' => 'text2', 'name_db' => 'TEXT2', 'type' => 'text', 'sort' => '450'],
    ['name' => 'title3', 'name_db' => 'TITLE3', 'type' => 'text', 'sort' => '500'],
    ['name' => 'text3', 'name_db' => 'TEXT3', 'type' => 'text', 'sort' => '550'],
    ['name' => 'read', 'name_db' => 'READ', 'type' => 'text', 'sort' => '600'],
