    ...
    <div class="container">
        <div class="header__content ">
            <div class="header__item header__left">
                <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '143']) as $main) : ?>
...
<article class="about wow animate__animated animate__fadeInUp">
    <div class="container">
        <div class="about__content1">
            ...
            <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '144']) as $about) : ?>
    ...
    <div class="container">
        <div class="reviews__content">
            <div class="reviews__head">
                <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '145']) as $reviews) : ?>
                    <h1 class="reviews__title wow animate__animated animate__fadeIn">
                        <?= $reviews['title_dange'] ?>
                    </h1>

                    <div class="reviews__google__logo">
                        <img width="150px" alt="logotip google" src="<?= $reviews['img'] ?>" />
                    </div>

                    <h1 class="reviews__exellent"><?= $reviews['title_main'] ?></h1>
                <? endforeach ?>
...
<section class="container reviews__container mySwiper wow animate__animated animate__fadeInUp">
    <div class="swiper-wrapper">
        <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '146']) as $reviewsSlider) : ?>
            <article class="testimonials swiper-slide">
                ...
                <div class="testimonials__block">
                    ...
                    <div class="testimonials__content">
                        <div class="avatar">
                            <img alt="mijoz fotosurati" src="<?= $reviewsSlider['img'] ?>" />
                        </div>
...
<section class="services wow animate__animated animate__fadeInUp">
    <div class="container">
        <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '149'])  as $services) : ?>
            <h1 class="reviews__title wow animate__animated animate__fadeIn">
                <?= $services['title'] ?>
            </h1>
            ...
            <div class="services__column__right">
                <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '150']) as $accardion) : ?>
                    <div id="<?= $accardion['id'] ?>" class="tabcontent">
                        <img alt="xizmat fotosurati" src="<?= $accardion['img'] ?>" class="tabcontent__img" />
                    ...
                    <div class="portfolio__boxs swiper-slide">
                        <div class="portfolio__block">
                            <a href="/uz/projects/<?= $info['ID'] ?>">
                                <img alt="Kompaniya logotipi" class="portfolio__img" src="<?= $info['LOGO'] ?>" />
